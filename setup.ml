...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5ec32f2a245d41c76465c50e332a4372) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "build the netcore.async library";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Async_Controller"; "Async_Reactive"];
                      lib_pack = false;
                      lib_internal_modules = [];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "reactive.ml"});
               Executable
                 ({
                     cs_name = "netkat_test";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "=\152=\161\187XrmH\196\022\184\246D\021\170";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
