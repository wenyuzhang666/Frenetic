...
(* OASIS_START *)
(* DO NOT EDIT (digest: 869b7dcfbcf177fbb7446a2a24282625) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Async_Controller"; "DistributedCompiler"];
                      lib_pack = false;
                      lib_internal_modules = [];
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "\247\230x\132\190&k\165\138\212\214\250p\192\217I";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
