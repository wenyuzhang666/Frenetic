...
(* OASIS_START *)
(* DO NOT EDIT (digest: 30fadb058d48a58b9bd3ac1955205370) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules =
                        ["Discovery"; "Learning"; "Transaction"; "Query"];
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "M\221x\199\200H\242<\232O\228\028\156\131\239\174";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
