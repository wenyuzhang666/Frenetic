...
(* OASIS_START *)
(* DO NOT EDIT (digest: 28d2f13f56008b1f9dea3ef625293954) *)
(*
...
let setup_t =
  {
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "NetCore Documentation";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "fF2\151c\020f\004\203\190\129\201`\238H\186";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
